...
export type Region = RegionEnum.North_devon | RegionEnum.South_devon;

const fishSpeciesRegionToName: FishList = [
  {
    name: 'Bass',
    specimenWeight: 8.0,
  },
...
const fishSpeciesRegionToName2: FishList = [
  {
    name: 'Bass',
    specimenWeight: 8.0,
  },
...
export const allFishedWithRegions: FishByRegionData = [
  {
    region: RegionEnum.South_devon,
    fish: fishSpeciesRegionToName,
  },
  {
    region: RegionEnum.North_devon,
    fish: fishSpeciesRegionToName2,
  },
];
